// GameAnalytics v4.0.6 
// Original File:
// C:\Users\mahomedia\Maho\Works\Dev\SMSG\cc\external_lib\GA-SDK-JAVASCRIPT-master\GA-SDK-JAVASCRIPT-master\dist\GameAnalytics_v4.js
// https://github.com/GameAnalytics/GA-SDK-JAVASCRIPT/blob/master/dist/GameAnalytics.node.js
...
//var navigator_online      = true; // smsg.Main_Game_Control.Internet_Connection
    ...
    (function (device) {
        ...
        var GADevice = (function () {
            ...
            GADevice.updateConnectionType = function () {
                if (/*navigator.onLine*/ smsg.Main_Game_Control.Internet_Connection) {
            ...
            GADevice.getBrowserVersionString = function () {
                ...
                var MString = M[2] ? [M[1], M[2]] : [navigator_appName, navigator_appVersion, '-?'];
    ...
    (function (store_1) {
        ...
        var GAStore = (function () {
            function GAStore() {
                ...
                this.storeItems = {};
                try {
                    if (typeof cc.sys.localStorage === 'object') {
                        cc.sys.localStorage.setItem('testingLocalStorage', 'yes');
                        cc.sys.localStorage.removeItem('testingLocalStorage');
            ...
            GAStore.save = function () {
                ...
                cc.sys.localStorage.setItem(GAStore.KeyPrefix + GAStore.EventsStoreKey, JSON.stringify(GAStore.instance.eventsStore));
                cc.sys.localStorage.setItem(GAStore.KeyPrefix + GAStore.SessionsStoreKey, JSON.stringify(GAStore.instance.sessionsStore));
                cc.sys.localStorage.setItem(GAStore.KeyPrefix + GAStore.ProgressionStoreKey, JSON.stringify(GAStore.instance.progressionStore));
                cc.sys.localStorage.setItem(GAStore.KeyPrefix + GAStore.ItemsStoreKey, JSON.stringify(GAStore.instance.storeItems));
            };
            GAStore.load = function () {
                ...
                try {
                    GAStore.instance.eventsStore = JSON.parse(cc.sys.localStorage.getItem(GAStore.KeyPrefix + GAStore.EventsStoreKey));
                ...
                try {
                    GAStore.instance.sessionsStore = JSON.parse(cc.sys.localStorage.getItem(GAStore.KeyPrefix + GAStore.SessionsStoreKey));
                ...
                try {
                    GAStore.instance.progressionStore = JSON.parse(cc.sys.localStorage.getItem(GAStore.KeyPrefix + GAStore.ProgressionStoreKey));
                ...
                try {
                    GAStore.instance.storeItems = JSON.parse(cc.sys.localStorage.getItem(GAStore.KeyPrefix + GAStore.ItemsStoreKey));
        ...
        var SdkErrorTask = (function () {
            ...
            SdkErrorTask.execute = function (url, type, payloadData, secretKey) {
                ...
                request.onerror = function() {
                    smsg.Main_Game_Control.Check_Internet_Connection_Loop();
                };
    ...
    (function (http) {
        ...
        var GAHTTPApi = (function () {
            ...
            GAHTTPApi.sendRequest = function (url, payloadData, extraArgs, gzip, callback, callback2) {
                ...
                request.onerror = function() {
                    smsg.Main_Game_Control.Check_Internet_Connection_Loop(); // call this to check connection until online
                };
                request.open("POST", url, true);
                request.setRequestHeader("Content-Type", "application/json");
...
(function (gameanalytics) {
    ...
    (function (threading) {
        ...
        var GAThreading = (function () {
            ...
            GAThreading.ThreadWaitTimeInMs = 2000;
            GAThreading.ProcessEventsIntervalInSeconds = 16.0;
            return GAThreading;
        }());
...
(function (gameanalytics) {
    ...
    var GameAnalytics = (function () {
        ...
        GameAnalytics.init = function () {
            ...
            GameAnalytics.methodMap['endSessionImmediate'] = GameAnalytics.endSessionImmediate;
        ...
        GameAnalytics.endSessionImmediate = function () {
            {
                try {
                    GAThreading.endSessionAndStopQueue();
                }
        ...
        GameAnalytics.Get_User_ID = function () {
...
window.ga = window.ga || gameanalytics;
